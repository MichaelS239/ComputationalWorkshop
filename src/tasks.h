...
std::vector<std::function<void(void)>> const semester6_tasks = {
        Semester6Task1, Semester6Task2,  Semester6Task3, Semester6Task4,
        Semester6Task5, Semester6Task6,  Semester6Task7, Semester6Task8,
        []() {},        Semester6Task10, Semester6Task11};
